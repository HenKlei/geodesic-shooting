...
if __name__ == "__main__":
    ...
    image, v0, energies, Phi0, length = lddmm.register(input_, problem, sigma=0.1, epsilon=0.01, K=100, return_all=True)
    ...
    save_image(lddmm.push_forward(input_, Phi_half), FILEPATH_RESULTS + 'square_to_circle_half_speed.png')
