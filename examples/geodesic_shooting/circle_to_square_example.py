...
if __name__ == "__main__":
    ...
    problem = pyLDDMM.ImageRegistrationProblemGS(i1, alpha=1, gamma=1)

    # perform the registration
    lddmm = pyLDDMM.GeodesicShooting()
    im, v0, energies, Phi0, length = lddmm.register(i0, problem, sigma=0.1, epsilon=0.01, K=10, return_all=True)

    # save i0 aligned to i1
    saveimg('../example_images/out_c2s.png', im)

    plt_inverse = plot_warpgrid(Phi0, interval=2)
    plt_inverse.savefig('../example_images/out_c2s_warp_inverse.png')
