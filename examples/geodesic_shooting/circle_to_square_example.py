...
if __name__ == "__main__":
    ...
    image, v0, energies, Phi0, length = geodesic_shooting.register(input_, target, sigma=0.1, epsilon=0.01, iterations=50, return_all=True)
    ...
    save_image(geodesic_shooting.push_forward(input_, Phi_half), FILEPATH_RESULTS + 'circle_to_square_half_speed.png')
