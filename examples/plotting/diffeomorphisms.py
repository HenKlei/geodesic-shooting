...
if __name__ == "__main__":
    ...
    diffeomorphism.plot(title="Diffeomorphism", interval=2)
    inverse_diffeomorphism.plot(title="Inverse diffeomorphism")

    approximate_identity = diffeomorphism.push_forward(inverse_diffeomorphism)
    approximate_identity.plot(title="Diffeomorphism composed with inverse diffeomorphism")
    approximate_identity_2 = inverse_diffeomorphism.push_forward(diffeomorphism)
    approximate_identity_2.plot(title="Inverse diffeomorphism composed with diffeomorphism")
