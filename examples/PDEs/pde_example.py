...
if __name__ == "__main__":
    i0 = loadimg('./example_images/circle_small.png')
    i1 = loadimg('./example_images/square_small.png')
    ...
    u_transformed = lddmm_circle.push_forward(u_orig.to_numpy().reshape((33, 33)), Phi0)[-1]
...
#    problem.fom.visualize(u_orig - problem.fom.operator.source.from_numpy(u_transformed.ravel()), title='Difference of transformed and inverse transformed')
    ...
    saveimg('./example_images/out_square_inverse_transformed.png', square_inverse_transformed)
